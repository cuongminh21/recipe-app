    ...
    useEffect(() => {
        const checkIfSaved = async () => {
            try {
                ...
                console.error("Error checking if recipte is saved", error);
        ...
        const loadRecipeDetail = async () => {
            ...
            try {
                ...
                if (mealData) {
                    const transformedRecipe = MealAPI.transfromMealData(mealData)
                ...
                console.error("Error load recipe details", error);
            } finally {
                setLoading(false)
            }
        }
        ...
        <View style={recipeDetailStyles.container}>
            ...
            >
                <View style={recipeDetailStyles.headerContainer}>
                    ...
                    />
                    <View style={recipeDetailStyles.floatingButton}>
                        ...
                        <TouchableOpacity style={[recipeDetailStyles.floatingButton, { backgroundColor: isSaving ? COLORS.gray : COLORS.primary }]}
                    ...
                    recipe.youtubeUrl && (
                        <View style={recipeDetailStyles.sectionContainer}>
                            <View style={recipeDetailStyles.sectionTitleRow}>
                                ...
                                <Text style={recipeDetailStyles.sectionTitle}>Viewo Tutorial</Text>
                            </View>
                            <View style={recipeDetailStyles.videoCard}>
                                <Webview
                                    ...
                                    mediaPlaybackRequuiresUserAction={false}
                                />
                            </View>
                        </View>
                    )
                    ...
                    <View style={recipeDetailStyles.ingredientsGrid}>
                        {
                            recipe.ingredients.map((ingredient, index) => (
                                <View key={index} style={recipeDetailStyles.ingredientCard}>
                                    ...
                                    <View style={recipeDetailStyles.ingredientNumber}>
                                        <Ionicons name='chechmark-circle-outline' size={20} color={COLORS.textLight} />
                                    </View>
                                </View>
                            ))
                        }
                            ...
                            recipe.instructions.map((instruction, index) => (
                                <View key={index} style={recipeDetailStyles.instructionCard}>
                                    <LinearGradient
                                        ...
                                        style={recipeDetailStyles.sectionIcon}
                                    >
                                        <Text style={recipeDetailStyles.stepLabel}>{index + 1}</Text>
                                    </LinearGradient>
